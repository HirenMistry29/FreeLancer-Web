 ...
 const ResumeParser = () => {
  ...
  return (
    <main className="h-full w-full overflow-hidden">
      ...
      <div className="fixed justify-center px-2 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:justify-end ">
          <section className="mt-5 grow px-4 md:max-w-[600px] md:px-0">
            <div className="aspect-h-[9.5] aspect-w-7">
              <iframe src={`${fileUrl}#navpanes=0`} className="h-[650px] w-[160%]" />
            </div>
          </section>
          <FlexboxSpacer maxWidth={45} className="hidden md:block" />
        </div>
      <div className="grid md:grid-cols-6 w-[50%] ml-[50%] ">
